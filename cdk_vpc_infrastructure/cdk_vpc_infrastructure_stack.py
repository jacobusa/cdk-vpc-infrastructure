...
import cdk_vpc_infrastructure.config as config
from constructs import Construct


class CdkVpcInfrastructureStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        self.create_subnets()
        self.create_subnet_route_table_association()
    ...
    def create_routes(self):
        ...
        for route_table_id, routes in config.ROUTE_TABLE_ID_TO_ROUTES_MAP.items():
    ...
    def create_subnet_route_table_association(self):
    ...
    def create_route_tables(self):
        """Create Route Tables"""
        for route_table_id in config.ROUTE_TABLE_ID_TO_ROUTES_MAP:
